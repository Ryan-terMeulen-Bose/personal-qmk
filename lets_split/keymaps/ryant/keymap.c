...
[_LOWER] = LAYOUT_ortho_4x12( \
  KC_ESC,  _______, _______, _______, _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, KC_EQL, \
...
[_RAISE] = LAYOUT_ortho_4x12( \
  KC_PLUS, _______, _______, _______, _______, _______, _______, _______, _______, KC_LCBR, KC_RCBR, KC_PLUS, \
 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | Del  |  F6  |  F7  |  F8  |  F9  |  F10 | MW_D | Left | Down | Right|      | PGDN |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
...
[_MOVE] = LAYOUT_ortho_4x12( \
  KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_WH_U, _______, KC_UP,   _______, _______, KC_PGUP, \
  KC_DEL,  KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_WH_D, KC_LEFT, KC_DOWN, KC_RGHT, _______, KC_PGDN, \
...
[_MOUSE] = LAYOUT_ortho_4x12( \
  KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_WH_U, KC_BTN1, KC_MS_U, KC_BTN2, KC_BTN3, KC_PGUP, \
  KC_DEL,  KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_R, _______, KC_PGDN, \
  _______, KC_F11,  KC_F12,  KC_COPY, KC_PSTE, _______, KC_WBAK, KC_WFWD, _______, _______, _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
),
